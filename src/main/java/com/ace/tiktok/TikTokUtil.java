...
public class TikTokUtil {
    ...
    //视频保存目录
    private static final String videoSavePath = "C:\\tiktok\\";

    //分享链接（手动修改）
    private static String targetPath = "3.38 gOx:/ # 国风大典组了个颜值局# 国风大典 10.4，来国风大典，看盛世国风 https://v.douyin.com/ieWaX3pT/ 复制此链接，打开Dou音搜索，直接观看视频！";


    public static void main(String[] args) {
        parseUrl(targetPath);
//        System.out.println(HttpUtil.get("https://www.iesdouyin.com/web/api/v2/aweme/iteminfo/?item_ids=7282609737349303607"));
    }
