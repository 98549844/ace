...
/**
 * html页面与之关联的接口
 * var reqUrl = "http://localhost:8081/ace/websocket/" + cid;
 * socket = new WebSocket(reqUrl.replace("http", "ws"));
 */
@ServerEndpoint("/ace/websocket/{sid}")
@Component
public class WebSocketServer {
    private static final Logger log = LogManager.getLogger(WebSocketServer.class.getName());
