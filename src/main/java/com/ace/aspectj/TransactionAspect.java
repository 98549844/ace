...
//    @Before("@within(org.springframework.stereotype.Controller) || @within(org.springframework.web.bind.annotation.RestController) || @within(org.springframework.stereotype.Component) || @within(org.springframework.stereotype.Repository)")
//    public void logBefore(JoinPoint joinPoint) {
//        String clazz = joinPoint.getSignature().getDeclaringTypeName() + "->" + joinPoint.getSignature().getName();
//        this.logs = record(clazz);
//        this.logs.setAspectType(AceLogs.BEFORE + "->");
//    }
//
//
//
...
//    }
//
//    @AfterReturning(pointcut = "@within(org.springframework.stereotype.Controller) || @within(org.springframework.web.bind.annotation.RestController) || @within(org.springframework.stereotype.Component) || @within(org.springframework.stereotype.Repository)")
//    public void logAfterReturning(JoinPoint joinPoint) {
//        this.logs.setAspectType(this.logs.getAspectType() + AceLogs.AFTER_RETURNING + "->");
//
//    }
//
//
...
//    @AfterThrowing(pointcut = "@within(org.springframework.stereotype.Controller) || @within(org.springframework.web.bind.annotation.RestController) || @within(org.springframework.stereotype.Component) || @within(org.springframework.stereotype.Repository)", throwing = "ex")
...
//        expBuilder.append("exp message: ").append(ex.getMessage()).append(PathUtil.newLine());
//        expBuilder.append("exp stackTrace: ").append(stackTrace);
//        this.logs.setException(expBuilder.toString()); //传入exception信息
//        this.logs.setAspectType(this.logs.getAspectType() + AceLogs.AFTER_THROWING + "->");
//
//    }
//
//    @After("@within(org.springframework.stereotype.Controller) || @within(org.springframework.web.bind.annotation.RestController) || @within(org.springframework.stereotype.Component) || @within(org.springframework.stereotype.Repository) ||")
//    public void after(JoinPoint joinPoint) {
//        this.logs.setAspectType(this.logs.getAspectType() + AceLogs.AFTER);
