                ...
                dialog = this.createDialog({
                    ...
                    buttons: {
                        enter: [lang.buttons.enter, function () {
                            ...
                            //这是播放MP4的html插入文
                            /*
                            <video class="video-js" controls preload="preload" width="100%" poster="" data-setup='{"aspectRatio":"16:9"}'>
                                <source src="/ace/image/get/25f4ffddcd6f4694bd943cb7fa692a05.mp4" type='video/mp4'>
                                    <p class="vjs-no-js"> To view this video please enable JavaScript </p>
                            </video>
                            */

                            //未解决插入text文本而不是html问题
                            if (url.endsWith(".mp4")) {
                                let videoHtml=`<video class="video-js" controls preload="auto" width="100%" poster="" data-setup='{"aspectRatio":"16:9"}'>
