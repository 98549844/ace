...
(
    ...
    sex              tinyint(2)          NOT NULL DEFAULT '10' COMMENT '性别 10:男;11:女;12:其他',
    avatar           varchar(100)                 DEFAULT NULL COMMENT '头像路径',
    status           tinyint(2)          NOT NULL DEFAULT '10' COMMENT '状态 10:正常;11:锁定;12:注销',
    ind_delete       tinyint(1)          NOT NULL DEFAULT '0' COMMENT '删除标识 0:未删除; 1:已删除',
...
INSERT INTO sys_user (user_name, real_name, password, sex, avatar, status, ind_delete, created_by, created_date,
                      last_update_by,
                      last_update_date, remark)
VALUES ('admin', '超级管理员', '$2a$10$j3XmUHGzMFLZFH.Qioq4Z.nM/iFMd4Wk6GDI.mC7U2yIztdyV6oUe', 10, '', 10, 0, 'admin',
        '2020-09-30 08:34:18.0', 'admin', '2020-09-30 08:34:18.0', '');
...
(
    ...
    ind_delete       tinyint(1)          NOT NULL DEFAULT '0' COMMENT '删除标识0:未删除;1:已删除',
    created_by       varchar(20)                  DEFAULT NULL COMMENT '创建者',
    created_date     timestamp           NULL     DEFAULT NULL COMMENT '创建时间',
    last_update_by   varchar(20)                  DEFAULT NULL COMMENT '更新者',
    last_update_date timestamp           NULL     DEFAULT NULL COMMENT '更新时间',
...
INSERT INTO sys_role (role_code, role_name, status, ind_delete, created_by, created_date, last_update_by,
                      last_update_date, remark)
VALUES ('admin', '超级管理员', 10, 0, 'admin', NULL, 'admin', NULL, NULL);
...
INSERT INTO sys_menu (menu_name, parent_id, order_num, url, menu_type, visible, perms, icon, created_by, created_date,
                      last_update_by, last_update_date, remark)
VALUES ('系统管理', 0, 1, '#', 10, 10, '', '#', 'admin', NULL, 'admin', NULL, NULL)
